...
int main() {
    ...
    cout << s.myAtoi(" b100") << endl;
    cout << s.myAtoi("wer10001er") << endl;
    cout << s.myAtoi("10001") << endl;
    cout << s.myAtoi("23423423423412412323213213123") << endl;
    cout << s.myAtoi("-4234234212145235234242342341") << endl;
