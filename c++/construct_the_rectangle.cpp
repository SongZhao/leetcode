...
int main() {
    ...
    cout << s.constructRectangle(1) << endl;
    cout << s.constructRectangle(8) << endl;
    cout << s.constructRectangle(15) << endl;
    cout << s.constructRectangle(5) << endl;
    cout << s.constructRectangle(9999998) << endl;
    return 0;
}
